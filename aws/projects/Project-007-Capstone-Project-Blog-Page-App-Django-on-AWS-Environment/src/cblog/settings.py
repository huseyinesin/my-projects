...
DATABASES = {
    'default': {
        ...
        'NAME': 'databasedb', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'capstone-rds.cmx6gkvaen8i.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'capstoneblog-huseyin' # please enter your s3 bucket name
